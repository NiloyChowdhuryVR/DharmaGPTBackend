...
const QnA = () => {
  ...
  const submitQs = async (e) => {
    ...
    try {
      const response = await fetch("https://dharmaback.onrender.com/gita", {
        method: "POST",
      ...
      if (data) {
        ...
        textAns.innerHTML =
          "<h2>Sorry, We couldn't Find any specific answer for your question in Bhagavad Gita. Please try searching another question</h2>";
      }
    } catch (e) {
      console.log(e);
    }
      ...
      <div className="qnaBox">
        ...
        <div className="loader">
          ...
          <h5 className="text-center">
            Please Wait while we search for the Answer...
          </h5>
        </div>
        <div className="answerBox">
          ...
          <br />
          <Container>
            <div className="questionBlock text-center">
              <h5 id="textQs"> </h5>
            </div>
            <div className="answerBlock text-center" id="textAns"></div>
          </Container>
        </div>
