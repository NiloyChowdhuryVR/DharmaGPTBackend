...
const QnATripitaka = () => {
  ...
  const submitQs = async (e)=>{
    ...
    textAns.innerHTML = "Answer => " + finalData;
      ...
      textAns.innerHTML = "<h2>Sorry, We couldn't Find any specific answer for your question in Tripitaka. Please try searching another question</h2>";
